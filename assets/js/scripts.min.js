    ...
    return (
      $(this).parent().hasClass("active")
        ? ($(this).next().slideUp(200),
          setTimeout(() => $(this).parent().removeClass("active"), 300))
        : ($(".faq .item").removeClass("active"),
          $(".faq .item__content").slideUp(200),
          $(this).next().slideDown(200),
          setTimeout(() => $(this).parent().addClass("active"), 300)),
      !1
    );
  });
}
...
function triggersCarousel() {
  $(".triggers__carousel").owlCarousel({
    items: 1,
    loop: false,
    nav: !1,
    dots: !0,
...
function sertCarousel() {
  $(".sert__carousel").owlCarousel({
    items: 1,
    // margin: 10,
    loop: true,
    nav: true,
...
function lisenseCarousel() {
  $(".lisense__carousel").owlCarousel({
    items: 1,
    // margin: 10,
    loop: true,
    nav: true,
...
function machinCarousel() {
  $(".machin__carousel").owlCarousel({
    items: 1,
    // margin: 10,
    loop: true,
    nav: true,
...
function rewCarousel() {
  $(".rew__carousel").owlCarousel({
    items: 5,
    margin: 20,
    loop: true,
    nav: true,
...
//     },
//   }),
//     $(".reviews__caption-nav_prev").click(function () {
//       t.trigger("prev.owl.carousel");
//     }),
//     $(".reviews__caption-nav_next").click(function () {
...
function contactsCarousel() {
  $(".contacts .item__carousel").owlCarousel({
    items: 1,
    loop: false,
    nav: !0,
    dots: !1,
...
function modals() {
  $(".modal__close").click(function () {
    $(".modal").removeClass("active"),
      $(".modal__overlay").toggleClass("active"),
...
function mobileBurger() {
  $(document).on("click", ".top-mobile__burger a", function () {
    return $(".nav").toggleClass("active"), !1;
  }),
    $(document).on("click", ".nav__close", function () {
      return $(".nav").removeClass("active"), !1;
    });
}

function contactsNav() {
  $(document).on("click", ".contacts__nav li a", function () {
    let t = $(this),
      e = t.parent().index();
    return (
      $(".contacts__nav li").removeClass("active"),
      t.parent().addClass("active"),
      e++,
      $(".contacts__items .item").removeClass("active"),
      $(".contacts__items .item:nth-child(" + e + ")").addClass("active"),
      !1
    );
  });
}
...
function tabs() {
  $(document).on("click", "[data-tabs-nav] li a", function () {
    let t = $(this).parent().index(),
      e = $(this).closest("[data-tabs-nav]"),
      n = $('[data-tabs-content="' + e.data("tabs-nav") + '"]');
    return (
      e.find("li").removeClass("active"),
      $(this).parent().addClass("active"),
      n.find(".item").removeClass("active"),
      n.find(".item").eq(t).addClass("active"),
      !1
    );
  }),
    $(document).on("click", "[data-more]", function () {
      return $(this).prev().addClass("showed"), $(this).remove(), !1;
    });
}
!(function (t, e) {
  "use strict";
  ...
  var _ = (function (t) {
    ...
    try {
      L.apply((P = j.call(w.childNodes)), w.childNodes),
    ...
    (st.attr = function (t, e) {
      ...
      var o = i.attrHandle[e.toLowerCase()],
        s = o && k.call(i.attrHandle, e.toLowerCase()) ? o(t, e, !g) : void 0;
      return void 0 !== s
        ? s
        : n.attributes || !g
        ? t.getAttribute(e)
      ...
      var n = e.length > 0,
        ...
        s = function (s, r, a, l, u) {
          ...
          for (
            ...
            if (o && h) {
              for (
                f = 0, r || h.ownerDocument === p || (d(h), (a = !g));
                (m = t[f++]);
          ...
          if (((v += y), n && y !== v)) {
            ...
            L.apply(l, x),
              u && !s && x.length > 0 && v + e.length > 1 && st.uniqueSort(l);
          }
          return u && ((C = $), (c = w)), b;
        };
      return n ? at(s) : s;
  ...
  (x.filter = function (t, e, n) {
    ...
    x.fn.extend({
      ...
      is: function (t) {
        return !!P(this, "string" == typeof t && S.test(t) ? x(t) : t || [], !1)
          .length;
      },
    });
  var D,
      ...
      function (t, e) {
        x.fn[t] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (j[t] || x.uniqueSort(o), L.test(t) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
  ...
  (x.Callbacks = function (t) {
    ...
    x.extend({
        ...
        var n = [
          ...
          o = {
            ...
            then: function (e, i, o) {
                    ...
                    c = function () {
                      ...
                      if (!(e < s)) {
                        ...
                        (c =
                          ...
                          g(c)
                            ? o
                              ? c.call(t, r(s, n, H, o), r(s, n, N, o))
                              : (s++,
                                c.call(
                                  t,
                                  r(s, n, H, o),
                                  r(s, n, N, o),
                                  r(s, n, H, n.notifyWith)
                                ))
                            : (i !== H && ((a = void 0), (l = [t])),
                              (o || n.resolveWith)(a, l));
                      }
              ...
              return x
                .Deferred(function (t) {
                  n[0][3].add(r(0, t, g(o) ? o : H, t.notifyWith)),
                    n[1][3].add(r(0, t, g(e) ? e : H)),
                    n[2][3].add(r(0, t, g(i) ? i : N));
                })
                .promise();
            },
            promise: function (t) {
      ...
      when: function (t) {
        ...
        if (
          e <= 1 &&
          (I(t, r.done(a(n)).resolve, r.reject, !e),
    ...
    x.extend({
      ...
      ready: function (t) {
        (!0 === t ? --x.readyWait : x.isReady) ||
          ((x.isReady = !0),
          (!0 !== t && --x.readyWait > 0) || O.resolveWith(i, [x]));
      },
    }),
    (x.ready.then = O.then),
  ...
  function lt(t, e) {
    for (var n, i, o = [], s = 0, r = t.length; s < r; s++)
      (i = t[s]).style &&
        ...
        e
          ? ("none" === n &&
              ((o[s] = Z.get(i, "display") || null),
              o[s] || (i.style.display = "")),
            "" === i.style.display && it(i) && (o[s] = at(i)))
          : "none" !== n && ((o[s] = "none"), Z.set(i, "display", n)));
  ...
  function Lt(t, e) {
    ...
    if (1 === e.nodeType) {
      if (
        Z.hasData(t) &&
        ((s = Z.access(t)), (r = Z.set(e, s)), (c = s.events))
      )
  ...
  function zt(t, e, n, i) {
    ...
    if (
      d &&
      ((s = (o = mt(e, t[0].ownerDocument, !1, t, i)).firstChild),
      1 === o.childNodes.length && (o = s),
      s || i)
    ) {
      for (l = (a = x.map(pt(o, "script"), Dt)).length; h < d; h++)
        (c = o),
          h !== p &&
            ((c = x.clone(c, !0, !0)), l && x.merge(a, pt(c, "script"))),
          n.call(t[h], c, h);
      if (l)
          ...
          (c = a[h]),
            ht.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : y(c.textContent.replace(kt, ""), u, c));
    }
    return t;
  }
  ...
  function Mt(t, e, n) {
    for (var i, o = e ? x.filter(e, t) : t, s = 0; null != (i = o[s]); s++)
      n || 1 !== i.nodeType || x.cleanData(pt(i)),
        i.parentNode &&
          (n && x.contains(i.ownerDocument, i) && ft(pt(i, "script")),
  ...
  x.extend({
    ...
    clone: function (t, e, n) {
      ...
      if (
        ...
        for (r = pt(a), i = 0, o = (s = pt(t)).length; i < o; i++)
          jt(s[i], r[i]);
      if (e)
        if (n)
          for (s = s || pt(t), r = r || pt(a), i = 0, o = s.length; i < o; i++)
            Lt(s[i], r[i]);
        else Lt(t, a);
      return (
    ...
    x.fn.extend({
      ...
      empty: function () {
        for (var t, e = 0; null != (t = this[e]); e++)
          1 === t.nodeType && (x.cleanData(pt(t, !1)), (t.textContent = ""));
        return this;
      },
      clone: function (t, e) {
        return (
          ...
          function (t) {
            ...
            if (
              ...
              try {
                for (; n < i; n++)
                  1 === (e = this[n] || {}).nodeType &&
                    (x.cleanData(pt(e, !1)), (e.innerHTML = t));
                e = 0;
              } catch (t) {}
            }
      ...
      replaceWith: function () {
        ...
        return zt(
          ...
          function (e) {
            ...
            x.inArray(this, t) < 0 &&
              (x.cleanData(pt(this)), n && n.replaceChild(e, this));
          },
          t
        );
      },
    ...
    x.each(
      ...
      function (t, e) {
        x.fn[t] = function (t) {
          for (var n, i = [], o = x(t), s = o.length - 1, r = 0; r <= s; r++)
  ...
  function Zt(t, e, n, i, o, s) {
    ...
    for (; r < 4; r += 2)
      "margin" === n && (l += x.css(t, n + nt[r], !0, o)),
        i
          ? ("content" === n && (l -= x.css(t, "padding" + nt[r], !0, o)),
            "margin" !== n &&
              (l -= x.css(t, "border" + nt[r] + "Width", !0, o)))
          : ((l += x.css(t, "padding" + nt[r], !0, o)),
            "padding" !== n
              ? (l += x.css(t, "border" + nt[r] + "Width", !0, o))
              : (a += x.css(t, "border" + nt[r] + "Width", !0, o)));
    return (
      !i &&
        s >= 0 &&
        (l += Math.max(
  ...
  function Qt(t, e, n) {
    ...
    return (
      ...
      ("auto" === o ||
        ...
        ((o = t["offset" + e[0].toUpperCase() + e.slice(1)]), (r = !0)),
      (o = parseFloat(o) || 0) +
        Zt(t, e, n || (s ? "border" : "content"), r, i, o) +
        "px"
    );
  }
  ...
  x.extend({
    ...
    style: function (t, e, n, i) {
      if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
        var o,
          ...
          c = t.style;
        if (
          (l || (e = Vt(a)), (r = x.cssHooks[e] || x.cssHooks[a]), void 0 === n)
        )
    ...
    x.each(["height", "width"], function (t, e) {
      x.cssHooks[e] = {
        get: function (t, n, i) {
          if (n)
            return !Ft.test(x.css(t, "display")) ||
    ...
    (x.cssHooks.marginLeft = Ot(f.reliableMarginLeft, function (t, e) {
      if (e)
        return (
  ...
  function se(t, e, n) {
    for (
      var i,
        o = (re.tweeners[e] || []).concat(re.tweeners["*"]),
        s = 0,
        r = o.length;
      s < r;
      s++
        ...
        if ((l = !x.isEmptyObject(e)) || !x.isEmptyObject(p))
          ...
          p))
            l ||
              ...
              g && lt([t], !0),
              d.done(function () {
                for (i in (g || lt([t]), Z.remove(t, "fxshow"), p))
                  x.style(t, i, p[i]);
              })),
              (l = se(g ? m[i] : 0, i, d)),
              i in m ||
          ...
          return void 0 === t.getAttribute
            ...
            : ((1 === s && x.isXMLDoc(t)) ||
                (o =
                  ...
                  (x.expr.match.bool.test(e) ? ae : void 0)),
              void 0 !== n
                ? null === n
      ...
      propHooks: {
        tabIndex: {
          get: function (t) {
            ...
            return e
              ? parseInt(e, 10)
              : ce.test(t.nodeName) || (ue.test(t.nodeName) && t.href)
              ? 0
              : -1;
          },
        },
      ...
      toggleClass: function (t, e) {
        ...
        return "boolean" == typeof e && i
          ...
          : this.each(function () {
              var e, o, s, r;
              if (i)
                for (o = 0, s = x(this), r = pe(t); (e = r[o++]); )
                  s.hasClass(e) ? s.removeClass(e) : s.addClass(e);
              else
                (void 0 !== t && "boolean" !== n) ||
                  ((e = de(this)) && Z.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
    ...
    x.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (t, e) {
            for (
              var n, i, o = t.options, s = x.makeArray(e), r = o.length;
              r--;
  ...
  x.extend(x.event, {
    trigger: function (e, n, o, s) {
      ...
      if (
        ...
        if (!s && !p.noBubble && !m(o)) {
          for (
            c = p.delegateType || y, ge.test(c + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            v.push(a), (l = a);
        ...
        for (r = 0; (a = v[r++]) && !e.isPropagationStopped(); )
          (f = a),
            ...
            (d = (Z.get(a, "events") || {})[e.type] && Z.get(a, "handle")) &&
              d.apply(a, n),
            (d = u && a[u]) &&
              d.apply &&
              V(a) &&
  ...
  (ze.href = ve.href),
    x.extend({
      ...
      ajax: function (e, n) {
        ...
        f.hasContent
          ...
          : ((p = f.url.slice(s.length)),
            f.data &&
              ...
              ((s += (be.test(s) ? "&" : "?") + f.data), delete f.data),
            !1 === f.cache &&
              ((s = s.replace(Ee, "$1")),
              (p = (be.test(s) ? "&" : "?") + "_=" + ye++ + p)),
            (f.url = s + p)),
        f.ifModified &&
          (x.lastModified[s] &&
            $.setRequestHeader("If-Modified-Since", x.lastModified[s]),
          x.etag[s] && $.setRequestHeader("If-None-Match", x.etag[s])),
        ...
        $.setRequestHeader(
          ...
          f.dataTypes[0] && f.accepts[f.dataTypes[0]]
            ? f.accepts[f.dataTypes[0]] +
                ("*" !== f.dataTypes[0] ? ", " + je + "; q=0.01" : "")
            : f.accepts["*"]
        ),
        f.headers))
          $.setRequestHeader(d, f.headers[d]);
        if (f.beforeSend && (!1 === f.beforeSend.call(g, $, f) || u))
          return $.abort();
        if (
          ((_ = "abort"),
          y.add(f.complete),
          ...
          if ((($.readyState = 1), h && m.trigger("ajaxSend", [$, f]), u))
            return $;
          f.async &&
            f.timeout > 0 &&
            ...
            c
              ? (f.ifModified &&
                  ((C = $.getResponseHeader("Last-Modified")) &&
                    (x.lastModified[s] = C),
                  (C = $.getResponseHeader("etag")) && (x.etag[s] = C)),
                204 === e || "HEAD" === f.type
                  ? (_ = "nocontent")
                  : 304 === e
                  ? (_ = "notmodified")
                  : ((_ = w.state), (d = w.data), (c = !(p = w.error))))
              : ((p = _), (!e && _) || ((_ = "error"), e < 0 && (e = 0))),
            ($.status = e),
            ($.statusText = (n || _) + ""),
            c ? v.resolveWith(g, [d, _, $]) : v.rejectWith(g, [$, _, p]),
            $.statusCode(b),
            (b = void 0),
            h && m.trigger(c ? "ajaxSuccess" : "ajaxError", [$, f, c ? d : p]),
            y.fireWith(g, [$, _]),
            h &&
              (m.trigger("ajaxComplete", [$, f]),
  ...
  x.ajaxSetup({
        ...
        return (
          ...
          i.always(function () {
            void 0 === s ? x(t).removeProp(o) : (t[o] = s),
              e[o] && ((e.jsonpCallback = n.jsonpCallback), Oe.push(o)),
              r && g(s) && s(r[0]),
              (r = s = void 0);
          }),
          "script"
    ...
    x.each(["top", "left"], function (t, e) {
      x.cssHooks[e] = Ot(f.pixelPosition, function (t, n) {
        if (n)
          return (n = qt(t, e)), Ht.test(n) ? x(t).position()[e] + "px" : n;
      });
    }),
    x.each(
      {
            ...
            this.trigger("unmask").each(function () {
              ...
              function v(t, e) {
                ...
                if (!(0 > t)) {
                  for (n = t, i = m(e); d > n; n++)
                    if (l[n]) {
                      if (!(d > i && l[n].test(_[i]))) break;
                      (_[n] = _[i]), (_[i] = g(i)), (i = m(i));
                    }
                  x(), C.caret(Math.max(u, t));
                }
              }
              ...
              function w(t) {
                ...
                for (e = 0, i = 0; d > e; e++)
                  if (l[e]) {
                    for (_[e] = g(e); i++ < o.length; )
                      if (((n = o.charAt(i - 1)), l[e].test(n))) {
                        (_[e] = n), (s = e);
                        break;
                      }
                    if (i > o.length) {
                ...
                return (
                  t
                    ...
                    ? r.autoclear || _.join("") === $
                      ? (C.val() && C.val(""), b(0, d))
                      : x()
                    : (x(), C.val(C.val().substring(0, s + 1))),
                  c ? e : u
                );
              }
              var C = t(this),
                _ = t.map(n.split(""), function (t, e) {
                    ...
                    if (!C.prop("readonly")) {
                      ...
                      (p = C.val()),
                        8 === s || 46 === s || (i && 127 === s)
                          ...
                          ? y.call(this, t)
                          : 27 === s &&
                            (C.val(T), C.caret(0, w()), t.preventDefault());
                    }
                  })
                  .on("keypress.mask", function (e) {
                    if (!C.prop("readonly")) {
                      var n,
                        ...
                        a = C.caret();
                      if (
                        !(e.ctrlKey || e.altKey || e.metaKey || 32 > r) &&
                        r &&
                        13 !== r
                      ) {
                        if (
                          (a.end - a.begin != 0 &&
                            (b(a.begin, a.end), v(a.begin, a.end - 1)),
                          (n = m(a.begin - 1)),
                          d > n && ((i = String.fromCharCode(r)), l[n].test(i)))
                        ) {
                          if (
                            ((function (t) {
                              var e, n, i, o;
                ...
                o &&
                  ...
                  C.off("input.mask").on("input.mask", function () {
                    ...
                    if (p && p.length && p.length > t.length) {
                      for (w(!0); e.begin > 0 && !l[e.begin - 1]; ) e.begin--;
                      if (0 === e.begin)
                        for (; e.begin < u && !l[e.begin]; ) e.begin++;
                      C.caret(e.begin, e.begin);
                    } else {
                      for (w(!0); e.begin < d && !l[e.begin]; ) e.begin++;
                      C.caret(e.begin, e.begin);
                    }
                    f();
                  }),
      ...
      (r = t.extend(!0, {}, e, s.opts.media)),
        t.each(r, function (e, i) {
          if ((l = p.match(i.matcher))) {
            if (
              ((f = i.type), (d = e), (h = {}), i.paramPlace && l[i.paramPlace])
            ) {
  ...
  $(function () {
    $(".popular__carousel").length && popularCarousel(),
      $(".results__carousel").length && resultsCarousel(),
      $(".lisense__carousel").length && lisenseCarousel(),
      $(".machin__carousel").length && machinCarousel(),
      $(".sert__carousel").length && sertCarousel(),
      $(".rew__carousel").length && rewCarousel(),
      $(".doctors__carousel").length && doctorsCarousel(),
      $(".services__carousel").length && servicesCarousel(),
      $(".news__carousel").length && newsCarousel(),
      $(".partners__carousel").length && partnersCarousel(),
      $(".contacts .item__carousel").length && contactsCarousel(),
      $(".docs__carousel").length && docsCarousel(),
      $(".triggers__carousel").length && triggersCarousel(),
      $(".sliders__carousel").length && slidersCarousel(),
      $(".contacts__nav").length && contactsNav(),
      $(".clinic__carousel").length && clinicCarousel(),
      ...
      $(window).on("scroll", function () {
        $(window).scrollTop() > 50
          ? $(".top .mobile").addClass("scrolled")
          : $(".top .mobile").removeClass("scrolled");
      });
  });
